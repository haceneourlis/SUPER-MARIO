 ...
 * Elle vérifie à chaque instant si l'entité doit se déplacer à droite ou à gauche
...
public class Deplacement_entite extends Thread {
     ...
     * A chaque "DELAY", elle déplace l'entité à droite ou à gauche selon la direction spécifiée.
     */
    @Override
    public void run() {
        while (true) {
