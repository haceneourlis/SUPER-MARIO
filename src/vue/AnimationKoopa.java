...
public class AnimationKoopa extends Thread {
    ...
    // Variable qui va stocker l'index maximum de l'animation (le nombre d'images
    // dans l'animation)
    ...
    // Méthode run qui va vérifier si le joueur se déplace à gauche ou à droite et
    // incrémente l'index de l'animation en conséquence.
    @Override
    public void run() {
        this.ok = true;
        while (this.ok) {
